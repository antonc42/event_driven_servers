 ...
 * All rights reserved.
 *
 * $Id: libmavis_groups.c,v 1.20 2017/10/07 10:59:09 marc Exp marc $
 *
 */
...
static const char rcsid[] __attribute__ ((used)) = "$Id: libmavis_groups.c,v 1.20 2017/10/07 10:59:09 marc Exp marc $";
